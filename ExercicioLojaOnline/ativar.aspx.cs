...
namespace ExercicioLojaOnline
{
    public partial class ativar : System.Web.UI.Page
    {
        ...
        {
            string valor_encriptado = Request.QueryString["id"];

            string valor_desencriptado = DecryptString(valor_encriptado);
            ...
            myCommand.Parameters.AddWithValue("@cod_utilizador", valor_desencriptado);

            myCommand.CommandType = CommandType.StoredProcedure;
            myCommand.CommandText = "ativar_utilizador";
